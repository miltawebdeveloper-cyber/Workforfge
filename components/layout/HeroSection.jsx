      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full">
        ...
        >
          ...
          <m.div variants={fadeInUp} className="inline-flex items-center gap-2 mb-8 px-3 py-1 bg-white border border-slate-200 rounded-full shadow-sm">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-primary">Now Open: Business District</span>
          </m.div>
          ...
          <div className="relative mb-10">
            ...
            <m.h2 
              variants={fadeInUp}
              className="text-3xl md:text-5xl lg:text-7xl font-light tracking-tight text-slate-400 leading-[1.1]"
            >
              Precision-Crafted <br/>
              <span className="text-primary font-bold italic">Workspace Solutions.</span>
            </m.h2>
          </div>
          ...
          <m.div variants={fadeInUp} className="flex flex-col md:flex-row gap-8 mb-12 items-start">
            <p className="max-w-sm text-lg text-slate-500 font-medium border-l border-slate-200 pl-6 leading-relaxed">
              Eliminate operational friction with premium private offices designed for high-performance teams.
            </p>
          ...
          {/* Core Actions */}
          <m.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-5 w-full">
        ...
        <div className="p-8 bg-white/40 backdrop-blur-2xl border border-white/50 rounded-2xl shadow-2xl space-y-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h4 className="font-bold text-primary">Prestige Business Park</h4>
            </div>
          </div>
          <div className="h-[1px] bg-primary/5"></div>
          <p className="text-xs text-slate-500 font-medium">98% Occupancy • 2 Seats Left</p>
        </div>
      </m.div>
