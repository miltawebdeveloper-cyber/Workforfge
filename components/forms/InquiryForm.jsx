...
export default function InquiryForm() {
  ...
  if (status === "success") {
    return (
      <div className="bg-slate-50 border border-slate-200 p-12 text-center space-y-6">
        <div className="w-16 h-16 bg-primary text-white rounded-full flex items-center justify-center mx-auto mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-8 h-8">
            <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
          </svg>
        </div>
        <h3 className="text-2xl font-black text-primary uppercase tracking-widest">Inquiry Received</h3>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 text-left">
      <div className="group border-b border-primary/10 focus-within:border-[#2159dc] transition-colors">
        ...
        <input
          ...
          required
          className="w-full bg-transparent py-3 outline-none text-lg font-light text-primary"
        />
      </div>

      <div className="group border-b border-primary/10 focus-within:border-[#2159dc] transition-colors pb-1">
      ...
      <div className="group border-b border-primary/10 focus-within:border-[#2159dc] transition-colors">
        ...
        <textarea
          ...
          onChange={handleChange}
          required
          className="w-full bg-transparent py-3 outline-none text-lg font-light h-32 resize-none text-primary"
        ></textarea>
      </div>
      ...
      <button
        ...
        className="w-full py-5 bg-primary text-white font-black uppercase tracking-[0.3em] hover:bg-[#2159dc] transition-all text-xs shadow-xl active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
      >
